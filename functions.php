...
function moltodestroyed_scripts() {
  ...
  wp_enqueue_style( 'moltodestroyed-style', get_stylesheet_uri(), array(), '1.0.1' );
  
  wp_enqueue_script( 'google-scripts',  get_template_directory_uri() . '/js/google-scripts.js', array(), '1.0.1', false );
  ...
  wp_enqueue_script( 'moltodestroyed-toggle-animation', get_template_directory_uri() . '/js/toggle-animation.js', array(), '1.0.1', true );
