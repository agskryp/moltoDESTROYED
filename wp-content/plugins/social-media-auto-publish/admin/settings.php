...
<br>For detailed step by step instructions <b><a href="http://help.xyzscripts.com/docs/social-media-auto-publish/faq/how-can-i-create-linkedin-application/" target="_blank">Click here</a></b>.
	...
	<tr valign="top"><td> V2 API permissions <span class="mandatory">*</span>
	</td>
	<td>
	...
	Basic profile fields + company pages(Require API access approval from LinkedIn)
	<a href="https://business.linkedin.com/marketing-solutions/marketing-partners/become-a-partner/marketing-developer-program#submit" style="padding-left: 22px;" target="_blank">Apply for LinkedIn API access</a>
	</td></tr>
	<tr valign="top">
					<td>Message format for posting <img src="<?php echo $heimg?>"
...
jQuery(document).ready(function() {
  ...
  jQuery("#select_all_pages").click(function(){
   ...
   var smap_toggle_element_ids=['xyz_smap_post_permission','xyz_smap_include_categories','xyz_smap_peer_verification',
